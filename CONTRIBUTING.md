...
1. Provide Proof Manifests allowing the maintainers and other contributors to verify your changes without requiring they understand the nuances of all your code.
   ...
   A typical Proof Manifest includes:
   - A policy manifest
   - A test resource manifest
   - The expected result (validation, mutation, generation, or cleanup behavior)

   Include these manifests in the PR description whenever possible.
