...
type EphemeralReportSpec struct {
	...
	// +optional
	Summary reportv1alpha1.ReportSummary `json:"summary,omitempty"`

	// ReportResult provides result details
	// +optional
	Results []reportv1alpha1.ReportResult `json:"results,omitempty"`
}
...
func (r *EphemeralReport) GetResults() []reportv1alpha1.ReportResult {
	return r.Spec.Results
}

func (r *EphemeralReport) SetResults(results []reportv1alpha1.ReportResult) {
	r.Spec.Results = results
}

func (r *EphemeralReport) SetSummary(summary reportv1alpha1.ReportSummary) {
...
func (r *ClusterEphemeralReport) GetResults() []reportv1alpha1.ReportResult {
	return r.Spec.Results
}

func (r *ClusterEphemeralReport) SetResults(results []reportv1alpha1.ReportResult) {
	r.Spec.Results = results
}

func (r *ClusterEphemeralReport) SetSummary(summary reportv1alpha1.ReportSummary) {
	r.Spec.Summary = summary
}
