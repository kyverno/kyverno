...
type EphemeralReportSpec struct {
	...
	// +optional
	Summary policyreportv1beta1.PolicyReportSummary `json:"summary,omitempty"`

	// PolicyReportResult provides result details
	// +optional
	Results []policyreportv1beta1.PolicyReportResult `json:"results,omitempty"`
}
...
func (r *EphemeralReport) GetResults() []policyreportv1beta1.PolicyReportResult {
	return r.Spec.Results
}

func (r *EphemeralReport) SetResults(results []policyreportv1beta1.PolicyReportResult) {
	r.Spec.Results = results
}

func (r *EphemeralReport) SetSummary(summary policyreportv1beta1.PolicyReportSummary) {
...
func (r *ClusterEphemeralReport) GetResults() []policyreportv1beta1.PolicyReportResult {
	return r.Spec.Results
}

func (r *ClusterEphemeralReport) SetResults(results []policyreportv1beta1.PolicyReportResult) {
	r.Spec.Results = results
}

func (r *ClusterEphemeralReport) SetSummary(summary policyreportv1beta1.PolicyReportSummary) {
	r.Spec.Summary = summary
}
