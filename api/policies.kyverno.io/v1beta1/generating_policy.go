...
// NamespacedGeneratingPolicy represents a namespaced CEL-based generating policy.
...
func (s *NamespacedGeneratingPolicy) GetWebhookConfiguration() *WebhookConfiguration {
	return s.Spec.WebhookConfiguration
}
