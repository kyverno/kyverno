...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamespacedMutatingPolicyAutogen) DeepCopyInto(out *NamespacedMutatingPolicyAutogen) {
	*out = *in
	if in.Targets != nil {
		in, out := &in.Targets, &out.Targets
		*out = make([]Target, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamespacedMutatingPolicyAutogen.
func (in *NamespacedMutatingPolicyAutogen) DeepCopy() *NamespacedMutatingPolicyAutogen {
	if in == nil {
		return nil
	}
	out := new(NamespacedMutatingPolicyAutogen)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NamespacedMutatingPolicyAutogenStatus) DeepCopyInto(out *NamespacedMutatingPolicyAutogenStatus) {
	*out = *in
	if in.Configs != nil {
		in, out := &in.Configs, &out.Configs
		*out = make(map[string]NamespacedMutatingPolicyAutogen, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NamespacedMutatingPolicyAutogenStatus.
func (in *NamespacedMutatingPolicyAutogenStatus) DeepCopy() *NamespacedMutatingPolicyAutogenStatus {
	if in == nil {
		return nil
	}
	out := new(NamespacedMutatingPolicyAutogenStatus)
	in.DeepCopyInto(out)
	return out
}
