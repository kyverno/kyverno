...
// // DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
// func (in *ValidatingAdmissionPolicyReport) DeepCopyInto(out *ValidatingAdmissionPolicyReport) {
// 	*out = *in
// 	out.TypeMeta = in.TypeMeta
// 	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
// 	if in.Scope != nil {
...
// // DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterPolicyReport.
// func (in *ValidatingAdmissionPolicyReport) DeepCopy() *ValidatingAdmissionPolicyReport {
// 	if in == nil {
// 		return nil
// 	}
// 	out := new(ValidatingAdmissionPolicyReport)
// 	in.DeepCopyInto(out)
// 	return out
// }

// // DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
// func (in *ValidatingAdmissionPolicyReport) DeepCopyObject() runtime.Object {
// 	if c := in.DeepCopy(); c != nil {
// 		return c
// 	}
// 	return nil
...
// // DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
// func (in *ValidatingAdmissionPolicyReportList) DeepCopyInto(out *ValidatingAdmissionPolicyReportList) {
// 	*out = *in
// 	out.TypeMeta = in.TypeMeta
// 	in.ListMeta.DeepCopyInto(&out.ListMeta)
// 	if in.Items != nil {
// 		in, out := &in.Items, &out.Items
// 		*out = make([]ValidatingAdmissionPolicyReport, len(*in))
// 		for i := range *in {
// 			(*in)[i].DeepCopyInto(&(*out)[i])
// 		}
// 	}
...
// // DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterPolicyReportList.
// func (in *ValidatingAdmissionPolicyReportList) DeepCopy() *ValidatingAdmissionPolicyReportList {
// 	if in == nil {
// 		return nil
// 	}
// 	out := new(ValidatingAdmissionPolicyReportList)
// 	in.DeepCopyInto(out)
// 	return out
// }

// // DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
// func (in *ValidatingAdmissionPolicyReportList) DeepCopyObject() runtime.Object {
// 	if c := in.DeepCopy(); c != nil {
// 		return c
// 	}
// 	return nil
