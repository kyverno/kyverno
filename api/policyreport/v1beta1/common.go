...
const (
	SeverityCritical PolicyResultSeverity = "critical"
	SeverityHigh     PolicyResultSeverity = "high"
	SeverityMedium   PolicyResultSeverity = "medium"
	SeverityLow      PolicyResultSeverity = "low"
	SeverityInfo     PolicyResultSeverity = "info"
)
