...
type UpdateRequestStatus struct {
	...
	GeneratedResources []kyvernov2beta1.ResourceSpec `json:"generatedResources,omitempty" yaml:"generatedResources,omitempty"`
}
...
type UpdateRequestSpec struct {
	...
	Resource kyvernov2beta1.ResourceSpec `json:"resource" yaml:"resource"`
