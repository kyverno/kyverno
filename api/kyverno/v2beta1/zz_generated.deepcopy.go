...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VerifyImages) DeepCopyInto(out *VerifyImages) {
	*out = *in
	if in.ImageReferences != nil {
		in, out := &in.ImageReferences, &out.ImageReferences
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VerifyImages.
func (in *VerifyImages) DeepCopy() *VerifyImages {
	if in == nil {
		return nil
	}
	out := new(VerifyImages)
