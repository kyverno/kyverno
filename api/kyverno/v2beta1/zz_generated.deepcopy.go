...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExcludeImageReferences) DeepCopyInto(out *ExcludeImageReferences) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExcludeImageReferences.
func (in *ExcludeImageReferences) DeepCopy() *ExcludeImageReferences {
	if in == nil {
		return nil
	}
	out := new(ExcludeImageReferences)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PolicyExceptionSpec) DeepCopyInto(out *PolicyExceptionSpec) {
	*out = *in
	...
	in.VerifyImages.DeepCopyInto(&out.VerifyImages)
	return
}
