...
func (p *ClusterPolicy) Validate(clusterResources sets.Set[string]) (warnings, errs field.ErrorList) {
	...
	warnings, errors := p.Spec.Validate(field.NewPath("spec"), p.IsNamespaced(), p.Namespace, clusterResources)
