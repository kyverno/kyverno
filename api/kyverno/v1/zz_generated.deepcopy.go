...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in AdmissionOperations) DeepCopyInto(out *AdmissionOperations) {
	{
		in := &in
		*out = make(AdmissionOperations, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdmissionOperations.
func (in AdmissionOperations) DeepCopy() AdmissionOperations {
	if in == nil {
		return nil
	}
	out := new(AdmissionOperations)
	in.DeepCopyInto(out)
	return *out
}
