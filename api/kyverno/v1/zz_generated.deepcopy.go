...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CELCondition) DeepCopyInto(out *CELCondition) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CELCondition.
func (in *CELCondition) DeepCopy() *CELCondition {
	if in == nil {
		return nil
	}
	out := new(CELCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Precondition) DeepCopyInto(out *Precondition) {
	*out = *in
	...
	if in.CELConditions != nil {
		in, out := &in.CELConditions, &out.CELConditions
		*out = make([]CELCondition, len(*in))
		copy(*out, *in)
	}
}
