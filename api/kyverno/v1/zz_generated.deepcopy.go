...
func (in *ForEachGeneration) DeepCopyInto(out *ForEachGeneration) {
	*out = *in
	if in.GenerateSubResources != nil {
		in, out := &in.GenerateSubResources, &out.GenerateSubResources
		*out = make([]GenerateSubResource, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GenerateSubResource) DeepCopyInto(out *GenerateSubResource) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GenerateSubResource.
func (in *GenerateSubResource) DeepCopy() *GenerateSubResource {
	if in == nil {
		return nil
	}
	out := new(GenerateSubResource)
	in.DeepCopyInto(out)
	return out
}
