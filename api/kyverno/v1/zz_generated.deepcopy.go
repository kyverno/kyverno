...
func (in *MatchResources) DeepCopyInto(out *MatchResources) {
	*out = *in
	if in.RequestTypes != nil {
		in, out := &in.RequestTypes, &out.RequestTypes
		*out = make(RequestTypes, len(*in))
		copy(*out, *in)
	}
	if in.Any != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in RequestTypes) DeepCopyInto(out *RequestTypes) {
	{
		in := &in
		*out = make(RequestTypes, len(*in))
		copy(*out, *in)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RequestTypes.
func (in RequestTypes) DeepCopy() RequestTypes {
	if in == nil {
		return nil
	}
	out := new(RequestTypes)
	in.DeepCopyInto(out)
	return *out
}
