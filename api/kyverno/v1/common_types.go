...
type ForEachMutation struct {
	...
	// +optional
	ForEachMutation *apiextv1.JSON `json:"foreach,omitempty"`
}
...
type Deny struct {
	...
	RawAnyAllConditions *apiextv1.JSON `json:"conditions,omitempty"`
}
...
type ForEachValidation struct {
	...
	// Foreach declares a nested foreach iterator
	// +optional
	ForEachValidation *apiextv1.JSON `json:"foreach,omitempty"`
}
