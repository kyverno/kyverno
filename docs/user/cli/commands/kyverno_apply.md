...
```
  ...
  -s, --set strings            Variables that are required
      --skip-resourcefilters   Optional parameter passed with cluster flag to skip the resourceFilters field from the kyverno configuration present in the cluster
