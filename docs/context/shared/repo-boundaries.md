...
| [`docs/dev/proposals/`](../../dev/proposals/README.md) | Kyverno Design Proposals | The project's design-proposal process. Substantial new design work belongs here; `docs/designs/` is explicitly scoped to lightweight technical notes. The separate [`kyverno/KDP`](https://github.com/kyverno/KDP) repository contains historical proposals during the migration. |
