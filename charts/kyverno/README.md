...
| `podSecurityContext`                  | security context configuration                                                                                                                                                                                                                               | `{}`                                                                                                                                                                              |
...
| `podDisruptionBudget.maxUnavailable` | Configures the maximum unavailable pods for kyverno disruptions. Cannot used if `minAvailable` is set. |  |
