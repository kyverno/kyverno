...
| `podSecurityStandard`              | set desired pod security level `privileged`, `default`, `restricted`, `custom`, `baseline`. Set to `restricted` for maximum security for your cluster. See: https://kyverno.io/policies/pod-security/                                                                    | `baseline`                                                                                                                                                                         |
