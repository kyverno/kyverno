...
| `config.resourceFilters`           | list of resource types to be skipped by Kyverno. See [documentation](https://kyverno.io/docs/installation/#resource-filters) for details | `"[Event,*,*][*,kube-system,*][*,kube-public,*][*,kube-node-lease,*][Node,*,*][APIService,*,*][TokenReview,*,*][SubjectAccessReview,*,*][*,kyverno,*]"` |
