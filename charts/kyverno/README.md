...
| networkPolicy.prometheusNamespaceLabels | object | `{"app.kubernetes.io/name":"prometheus"}` | A list of matchLabels for matching pods with respective labels in the allow-prometheus network policy |
