...
func newFakeMetaClient() (metadatainformers.SharedInformerFactory, metafake.MetadataClient) {
	...
	return metadatainformers.NewSharedInformerFactory(client, 1*time.Minute), client.Resource(v1beta1.SchemeGroupVersion.WithResource("policyreports")).Namespace("default").(metafake.MetadataClient)
}

var (
	kyvernoPolr = &v1beta1.PolicyReport{
	...
	notKyvernoPolr = &v1beta1.PolicyReport{
		ObjectMeta: metav1.ObjectMeta{
...
func TestController(t *testing.T) {
	...
	client.Wgpolicyk8sV1beta1().PolicyReports("default").Create(context.TODO(), kyvernoPolr, metav1.CreateOptions{})
	client.Wgpolicyk8sV1beta1().PolicyReports("default").Create(context.TODO(), notKyvernoPolr, metav1.CreateOptions{})
	...
	list, _ := client.Wgpolicyk8sV1beta1().PolicyReports("default").List(context.TODO(), metav1.ListOptions{})
