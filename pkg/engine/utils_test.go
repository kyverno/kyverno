...
func TestMatchesResourceDescription(t *testing.T) {
	...
	for i, tc := range tcs {
		...
		for _, rule := range autogen.ComputeRules(&policy) {
			err := MatchesResourceDescription(make(map[string]*metav1.APIResource), *resource, rule, tc.AdmissionInfo, []string{}, nil, "", "", false)
			if err != nil {
...
func TestResourceDescriptionMatch_MultipleKind(t *testing.T) {
	...
	if err := MatchesResourceDescription(make(map[string]*metav1.APIResource), *resource, rule, v1beta1.RequestInfo{}, []string{}, nil, "", "", false); err != nil {
...
func TestResourceDescriptionMatch_ExcludeDefaultGroups(t *testing.T) {
	...
	if err := MatchesResourceDescription(make(map[string]*metav1.APIResource), *resource, rule, requestInfo, dynamicConfig, nil, "", "", false); err == nil {
	...
	if err := MatchesResourceDescription(make(map[string]*metav1.APIResource), *resource, rule2, requestInfo, dynamicConfig, nil, "", "", false); err != nil {
