...
func (eh EqualHandler) Evaluate(key, value interface{}) bool {
	...
	default:
		eh.log.V(4).Info("Unsupported type", "value", typedKey, "type", fmt.Sprintf("%T", typedKey))
		return false
	}
}
...
func (eh EqualHandler) validateValueWithSlicePattern(key []interface{}, value interface{}) bool {
	...
	eh.log.V(4).Info("Expected type []interface{}", "value", value, "type", fmt.Sprintf("%T", value))
	return false
}
...
func (eh EqualHandler) validateValueWithMapPattern(key map[string]interface{}, value interface{}) bool {
	...
	eh.log.V(4).Info("Expected type map[string]interface{}", "value", value, "type", fmt.Sprintf("%T", value))
	return false
}
...
func (eh EqualHandler) validateValueWithStringPattern(key string, value interface{}) bool {
	...
	eh.log.V(4).Info("Expected type string", "value", value, "type", fmt.Sprintf("%T", value))
	return false
}
...
func (eh EqualHandler) validateValueWithFloatPattern(key float64, value interface{}) bool {
	...
	case int:
		...
		eh.log.V(4).Info("Expected type float, found int", "typedValue", typedValue)
	case int64:
		// check that float has not fraction
		if key == math.Trunc(key) {
	...
	default:
		eh.log.V(4).Info("Expected type float", "value", value, "type", fmt.Sprintf("%T", value))
		return false
	}
	return false
}
...
func (eh EqualHandler) validateValueWithBoolPattern(key bool, value interface{}) bool {
	...
	if !ok {
		eh.log.V(4).Info("Expected type bool", "value", value, "type", fmt.Sprintf("%T", value))
		return false
	}
...
func (eh EqualHandler) validateValueWithIntPattern(key int64, value interface{}) bool {
	...
	case float64:
		...
		eh.log.V(4).Info("Expected type int, found float", "value", typedValue, "type", fmt.Sprintf("%T", typedValue))
		return false
	case string:
		...
		return int64Num == key
	default:
		eh.log.V(4).Info("Expected type int", "value", value, "type", fmt.Sprintf("%T", value))
		return false
	}
}
