...
func (neh NotEqualHandler) Evaluate(key, value interface{}) bool {
	...
	default:
		neh.log.V(4).Info("Unsupported type", "value", typedKey, "type", fmt.Sprintf("%T", typedKey))
		return false
	}
}
...
func (neh NotEqualHandler) validateValueWithSlicePattern(key []interface{}, value interface{}) bool {
	...
	neh.log.V(4).Info("Expected type []interface{}", "value", value, "type", fmt.Sprintf("%T", value))
	return true
}
...
func (neh NotEqualHandler) validateValueWithMapPattern(key map[string]interface{}, value interface{}) bool {
	...
	neh.log.V(4).Info("Expected type map[string]interface{}", "value", value, "type", fmt.Sprintf("%T", value))
	return true
}
...
func (neh NotEqualHandler) validateValueWithStringPattern(key string, value interface{}) bool {
	...
	neh.log.V(4).Info("Expected type string", "value", value, "type", fmt.Sprintf("%T", value))
	return true
}
...
func (neh NotEqualHandler) validateValueWithFloatPattern(key float64, value interface{}) bool {
	...
	case int:
		...
		neh.log.V(4).Info("Expected type float, found int", "typedValue", typedValue)
	case int64:
		// check that float has not fraction
		if key == math.Trunc(key) {
	...
	default:
		neh.log.V(4).Info("Expected type float", "value", value, "type", fmt.Sprintf("%T", value))
		return true
	}
	return true
}
...
func (neh NotEqualHandler) validateValueWithBoolPattern(key bool, value interface{}) bool {
	...
	if !ok {
		neh.log.V(4).Info("Expected type bool", "value", value, "type", fmt.Sprintf("%T", value))
		return true
	}
...
func (neh NotEqualHandler) validateValueWithIntPattern(key int64, value interface{}) bool {
	...
	case float64:
		...
		neh.log.V(4).Info("Expected type int, found float", "value", typedValue, "type", fmt.Sprintf("%T", typedValue))
		return false
	case string:
		...
		return int64Num != key
	default:
		neh.log.V(4).Info("Expected type int", "value", value, "type", fmt.Sprintf("%T", value))
		return true
	}
}
