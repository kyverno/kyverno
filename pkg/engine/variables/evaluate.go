...
func Evaluate(log logr.Logger, ctx context.EvalInterface, condition kyvernov2beta1.Condition) bool {
...
func EvaluateAnyAllConditions(log logr.Logger, ctx context.EvalInterface, conditions []kyvernov2beta1.AnyAllConditions) bool {
...
func evaluateOldConditions(log logr.Logger, ctx context.EvalInterface, conditions []kyvernov2beta1.Condition) bool {
