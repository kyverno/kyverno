...
func ApplyBackgroundChecks(rclient registryclient.Client, policyContext *api.PolicyContext) (resp *api.EngineResponse) {
	policyStartTime := time.Now()
	return filterRules(rclient, policyContext, policyStartTime)
}

func filterRules(rclient registryclient.Client, policyContext *api.PolicyContext, startTime time.Time) *api.EngineResponse {
...
func filterRule(rclient registryclient.Client, rule kyvernov1.Rule, policyContext *api.PolicyContext) *api.RuleResponse {
