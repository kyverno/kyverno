...
func filterRule(rule kyverno.Rule, policyContext *PolicyContext) *response.RuleResponse {
	...
	if err = MatchesResourceDescription(newResource, rule, admissionInfo, excludeGroupRole, namespaceLabels, policyContext.Policy.GetNamespace()); err != nil {
		// if the oldResource matched, return "false" to delete GR for it
		if err = MatchesResourceDescription(oldResource, rule, admissionInfo, excludeGroupRole, namespaceLabels, policyContext.Policy.GetNamespace()); err == nil {
