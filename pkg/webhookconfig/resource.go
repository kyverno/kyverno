...
func (wrc *WebhookRegistrationClient) RemoveResourceMutatingWebhookConfiguration() {
	...
	err := wrc.client.DeleteResource(wrc.ctx, "", MutatingWebhookConfigurationKind, "", configName, false)
...
func (wrc *WebhookRegistrationClient) RemoveResourceValidatingWebhookConfiguration() {
	...
	err := wrc.client.DeleteResource(wrc.ctx, "", ValidatingWebhookConfigurationKind, "", configName, false)
	if errors.IsNotFound(err) {
