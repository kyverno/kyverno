...
var (
	...
	allowedVariablesBackground         = regexp.MustCompile(`^(request\.|element(Index)?[0-9]*(\.|$)|@(\.|$)|images(\.|$)|image\.)|^([a-z_0-9]+\()[^{}]`)
	allowedVariablesInTarget           = regexp.MustCompile(`^(request\.|serviceAccountName(\.|$)|serviceAccountNamespace(\.|$)|element(Index)?[0-9]*(\.|$)|@(\.|$)|images(\.|$)|image\.|target\.)|^([a-z_0-9]+\()[^{}]`)
	allowedVariablesBackgroundInTarget = regexp.MustCompile(`^(request\.|element(Index)?[0-9]*(\.|$)|@(\.|$)|images(\.|$)|image\.|target\.)|^([a-z_0-9]+\()[^{}]`)
