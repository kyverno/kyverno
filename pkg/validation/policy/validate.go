...
var (
	...
	allowedVariablesBackground         = regexp.MustCompile(`^(request|element(Index)?[0-9]*|@|images|image)([^A-Za-z0-9_]|$)|^([a-z_0-9]+\()[^{}]`)
	allowedVariablesInTarget           = regexp.MustCompile(`^(request|serviceAccountName|serviceAccountNamespace|element(Index)?[0-9]*|@|images|image|target)([^A-Za-z0-9_]|$)|^([a-z_0-9]+\()[^{}]`)
	allowedVariablesBackgroundInTarget = regexp.MustCompile(`^(request|element(Index)?[0-9]*|@|images|image|target)([^A-Za-z0-9_]|$)|^([a-z_0-9]+\()[^{}]`)
