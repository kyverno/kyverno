...
// legacyNotaryVerifier is the original notary verifier implementation preserved for backward compatibility.
// This is used when the UnifiedNotaryAdapter feature flag is disabled.
type legacyNotaryVerifier struct {
	log logr.Logger
}

func newLegacyVerifier() images.ImageVerifier {
	return &legacyNotaryVerifier{
		log: logging.WithName("Notary-Legacy"),
	}
}

func (v *legacyNotaryVerifier) VerifySignature(ctx context.Context, opts images.Options) (*images.Response, error) {
...
func (v *legacyNotaryVerifier) buildPolicy() *trustpolicy.Document {
...
func (v *legacyNotaryVerifier) verifyOutcomes(outcomes []*notation.VerificationOutcome) error {
	var errs []error
...
func (v *legacyNotaryVerifier) FetchAttestations(ctx context.Context, opts images.Options) (*images.Response, error) {
	...
	for _, referrer := range referrersDescs.Manifests {
		...
		targetDesc, err := v.verifyAttestators(ctx, ref, opts, referrer)
		if err != nil {
...
func (v *legacyNotaryVerifier) verifyAttestators(ctx context.Context, ref name.Reference, opts images.Options, desc v1.Descriptor) (ocispec.Descriptor, error) {
