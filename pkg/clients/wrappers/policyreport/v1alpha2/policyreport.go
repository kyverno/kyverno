...
func (c *policyReportsControl) Create(ctx context.Context, policyReport *v1alpha2.PolicyReport, opts v1.CreateOptions) (*v1alpha2.PolicyReport, error) {
...
func (c *policyReportsControl) Update(ctx context.Context, policyReport *v1alpha2.PolicyReport, opts v1.UpdateOptions) (*v1alpha2.PolicyReport, error) {
...
func (c *policyReportsControl) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *policyReportsControl) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (c *policyReportsControl) Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.PolicyReport, error) {
...
func (c *policyReportsControl) List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.PolicyReportList, error) {
...
func (c *policyReportsControl) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
...
func (c *policyReportsControl) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.PolicyReport, err error) {
