...
func (c *clusterPolicyReportsControl) Create(ctx context.Context, clusterPolicyReport *v1alpha2.ClusterPolicyReport, opts v1.CreateOptions) (*v1alpha2.ClusterPolicyReport, error) {
...
func (c *clusterPolicyReportsControl) Update(ctx context.Context, clusterPolicyReport *v1alpha2.ClusterPolicyReport, opts v1.UpdateOptions) (*v1alpha2.ClusterPolicyReport, error) {
...
func (c *clusterPolicyReportsControl) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *clusterPolicyReportsControl) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (c *clusterPolicyReportsControl) Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.ClusterPolicyReport, error) {
...
func (c *clusterPolicyReportsControl) List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.ClusterPolicyReportList, error) {
...
func (c *clusterPolicyReportsControl) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
...
func (c *clusterPolicyReportsControl) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.ClusterPolicyReport, err error) {
