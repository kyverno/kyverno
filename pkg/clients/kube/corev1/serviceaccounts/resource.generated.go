...
func WithLogging(inner k8s_io_client_go_kubernetes_typed_core_v1.ServiceAccountInterface, logger logr.Logger) k8s_io_client_go_kubernetes_typed_core_v1.ServiceAccountInterface {
...
func (c *withLogging) Apply(arg0 context.Context, arg1 *k8s_io_client_go_applyconfigurations_core_v1.ServiceAccountApplyConfiguration, arg2 k8s_io_apimachinery_pkg_apis_meta_v1.ApplyOptions) (*k8s_io_api_core_v1.ServiceAccount, error) {
	start := time.Now()
...
func (c *withLogging) Create(arg0 context.Context, arg1 *k8s_io_api_core_v1.ServiceAccount, arg2 k8s_io_apimachinery_pkg_apis_meta_v1.CreateOptions) (*k8s_io_api_core_v1.ServiceAccount, error) {
	start := time.Now()
...
func (c *withLogging) CreateToken(arg0 context.Context, arg1 string, arg2 *k8s_io_api_authentication_v1.TokenRequest, arg3 k8s_io_apimachinery_pkg_apis_meta_v1.CreateOptions) (*k8s_io_api_authentication_v1.TokenRequest, error) {
	start := time.Now()
	logger := c.logger.WithValues("operation", "CreateToken")
	ret0, ret1 := c.inner.CreateToken(arg0, arg1, arg2, arg3)
	if err := multierr.Combine(ret1); err != nil {
		logger.Error(err, "CreateToken failed", "duration", time.Since(start))
	} else {
		logger.Info("CreateToken done", "duration", time.Since(start))
	}
	return ret0, ret1
}
...
func (c *withLogging) Get(arg0 context.Context, arg1 string, arg2 k8s_io_apimachinery_pkg_apis_meta_v1.GetOptions) (*k8s_io_api_core_v1.ServiceAccount, error) {
	start := time.Now()
...
func (c *withLogging) List(arg0 context.Context, arg1 k8s_io_apimachinery_pkg_apis_meta_v1.ListOptions) (*k8s_io_api_core_v1.ServiceAccountList, error) {
	start := time.Now()
...
func (c *withLogging) Patch(arg0 context.Context, arg1 string, arg2 k8s_io_apimachinery_pkg_types.PatchType, arg3 []uint8, arg4 k8s_io_apimachinery_pkg_apis_meta_v1.PatchOptions, arg5 ...string) (*k8s_io_api_core_v1.ServiceAccount, error) {
	start := time.Now()
...
func (c *withLogging) Update(arg0 context.Context, arg1 *k8s_io_api_core_v1.ServiceAccount, arg2 k8s_io_apimachinery_pkg_apis_meta_v1.UpdateOptions) (*k8s_io_api_core_v1.ServiceAccount, error) {
	start := time.Now()
...
func (c *withMetrics) CreateToken(arg0 context.Context, arg1 string, arg2 *k8s_io_api_authentication_v1.TokenRequest, arg3 k8s_io_apimachinery_pkg_apis_meta_v1.CreateOptions) (*k8s_io_api_authentication_v1.TokenRequest, error) {
	defer c.recorder.RecordWithContext(arg0, "create_token")
