...
type ReportChangeRequestControlInterface interface {
	Create(ctx context.Context, creportChangeRequest *v1alpha2.ReportChangeRequest, opts v1.CreateOptions) (*v1alpha2.ReportChangeRequest, error)
	Update(ctx context.Context, creportChangeRequest *v1alpha2.ReportChangeRequest, opts v1.UpdateOptions) (*v1alpha2.ReportChangeRequest, error)
...
func (c *reportChangeRequestControl) Create(ctx context.Context, reportChangeRequest *v1alpha2.ReportChangeRequest, opts v1.CreateOptions) (*v1alpha2.ReportChangeRequest, error) {
...
func (c *reportChangeRequestControl) Update(ctx context.Context, reportChangeRequest *v1alpha2.ReportChangeRequest, opts v1.UpdateOptions) (*v1alpha2.ReportChangeRequest, error) {
...
func (c *reportChangeRequestControl) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *reportChangeRequestControl) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (c *reportChangeRequestControl) Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.ReportChangeRequest, error) {
...
func (c *reportChangeRequestControl) List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.ReportChangeRequestList, error) {
...
func (c *reportChangeRequestControl) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
...
func (c *reportChangeRequestControl) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.ReportChangeRequest, err error) {
