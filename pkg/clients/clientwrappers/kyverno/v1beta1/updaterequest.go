...
func (c *updateRequestsControl) Create(ctx context.Context, updateRequest *v1beta1.UpdateRequest, opts v1.CreateOptions) (*v1beta1.UpdateRequest, error) {
...
func (c *updateRequestsControl) Update(ctx context.Context, updateRequest *v1beta1.UpdateRequest, opts v1.UpdateOptions) (*v1beta1.UpdateRequest, error) {
...
func (c *updateRequestsControl) UpdateStatus(ctx context.Context, updateRequest *v1beta1.UpdateRequest, opts v1.UpdateOptions) (*v1beta1.UpdateRequest, error) {
...
func (c *updateRequestsControl) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
...
func (c *updateRequestsControl) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (c *updateRequestsControl) Get(ctx context.Context, name string, opts v1.GetOptions) (*v1beta1.UpdateRequest, error) {
...
func (c *updateRequestsControl) List(ctx context.Context, opts v1.ListOptions) (*v1beta1.UpdateRequestList, error) {
	c.clientQueryMetric.Record(metrics.ClientCreate, metrics.KyvernoClient, "UpdateRequest", c.ns)
	return c.urClient.UpdateRequests(c.ns).List(ctx, opts)
}

func (c *updateRequestsControl) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
...
func (c *updateRequestsControl) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.UpdateRequest, err error) {
