...
import (
	...
	namespacedgeneratingpolicies "github.com/kyverno/kyverno/pkg/clients/kyverno/policiesv1alpha1/namespacedgeneratingpolicies"
...
func (c *withMetrics) NamespacedGeneratingPolicies(namespace string) github_com_kyverno_kyverno_pkg_client_clientset_versioned_typed_policies_kyverno_io_v1alpha1.NamespacedGeneratingPolicyInterface {
...
func (c *withTracing) NamespacedGeneratingPolicies(namespace string) github_com_kyverno_kyverno_pkg_client_clientset_versioned_typed_policies_kyverno_io_v1alpha1.NamespacedGeneratingPolicyInterface {
...
func (c *withLogging) NamespacedGeneratingPolicies(namespace string) github_com_kyverno_kyverno_pkg_client_clientset_versioned_typed_policies_kyverno_io_v1alpha1.NamespacedGeneratingPolicyInterface {
