...
import (
	...
	wgpolicyk8sv1beta1 "github.com/kyverno/kyverno/pkg/clients/kyverno/wgpolicyk8sv1beta1"
...
type clientset struct {
	...
	wgpolicyk8sv1beta1 github_com_kyverno_kyverno_pkg_client_clientset_versioned_typed_policyreport_v1beta1.Wgpolicyk8sV1beta1Interface
}
...
func (c *clientset) Wgpolicyk8sV1beta1() github_com_kyverno_kyverno_pkg_client_clientset_versioned_typed_policyreport_v1beta1.Wgpolicyk8sV1beta1Interface {
...
func WrapWithMetrics(inner github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface, m metrics.MetricsConfigManager, clientType metrics.ClientType) github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface {
	return &clientset{
		...
		wgpolicyk8sv1beta1: wgpolicyk8sv1beta1.WithMetrics(inner.Wgpolicyk8sV1beta1(), m, clientType),
	}
}
...
func WrapWithTracing(inner github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface) github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface {
	return &clientset{
		...
		wgpolicyk8sv1beta1: wgpolicyk8sv1beta1.WithTracing(inner.Wgpolicyk8sV1beta1(), "Wgpolicyk8sV1beta1"),
	}
}
...
func WrapWithLogging(inner github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface, logger logr.Logger) github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface {
	return &clientset{
		...
		wgpolicyk8sv1beta1: wgpolicyk8sv1beta1.WithLogging(inner.Wgpolicyk8sV1beta1(), logger.WithValues("group", "Wgpolicyk8sV1beta1")),
	}
}
