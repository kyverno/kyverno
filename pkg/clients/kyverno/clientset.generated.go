...
import (
	...
	policiesv1 "github.com/kyverno/kyverno/pkg/clients/kyverno/policiesv1"
...
type clientset struct {
	...
	policiesv1          github_com_kyverno_kyverno_pkg_client_clientset_versioned_typed_policies_v1.PoliciesV1Interface
...
func (c *clientset) PoliciesV1() github_com_kyverno_kyverno_pkg_client_clientset_versioned_typed_policies_v1.PoliciesV1Interface {
	return c.policiesv1
}
...
func WrapWithMetrics(inner github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface, m metrics.MetricsConfigManager, clientType metrics.ClientType) github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface {
	return &clientset{
		...
		policiesv1:          policiesv1.WithMetrics(inner.PoliciesV1(), m, clientType),
...
func WrapWithTracing(inner github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface) github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface {
	return &clientset{
		...
		policiesv1:          policiesv1.WithTracing(inner.PoliciesV1(), "PoliciesV1"),
...
func WrapWithLogging(inner github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface, logger logr.Logger) github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface {
	return &clientset{
		...
		policiesv1:          policiesv1.WithLogging(inner.PoliciesV1(), logger.WithValues("group", "PoliciesV1")),
