...
import (
	...
	openreportsv1alpha1 "github.com/kyverno/kyverno/pkg/clients/kyverno/openreportsv1alpha1"
...
type clientset struct {
	...
	openreportsv1alpha1 github_com_kyverno_kyverno_pkg_client_clientset_versioned_typed_openreports_io_v1alpha1.OpenreportsV1alpha1Interface
}
...
func (c *clientset) OpenreportsV1alpha1() github_com_kyverno_kyverno_pkg_client_clientset_versioned_typed_openreports_io_v1alpha1.OpenreportsV1alpha1Interface {
	return c.openreportsv1alpha1
}
...
func WrapWithMetrics(inner github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface, m metrics.MetricsConfigManager, clientType metrics.ClientType) github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface {
	return &clientset{
		...
		openreportsv1alpha1: openreportsv1alpha1.WithMetrics(inner.OpenreportsV1alpha1(), m, clientType),
	}
}
...
func WrapWithTracing(inner github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface) github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface {
	return &clientset{
		...
		openreportsv1alpha1: openreportsv1alpha1.WithTracing(inner.OpenreportsV1alpha1(), "OpenreportsV1alpha1"),
	}
}
...
func WrapWithLogging(inner github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface, logger logr.Logger) github_com_kyverno_kyverno_pkg_client_clientset_versioned.Interface {
	return &clientset{
		...
		openreportsv1alpha1: openreportsv1alpha1.WithLogging(inner.OpenreportsV1alpha1(), logger.WithValues("group", "OpenreportsV1alpha1")),
	}
}
