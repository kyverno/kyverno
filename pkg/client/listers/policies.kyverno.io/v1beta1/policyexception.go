...
type PolicyExceptionLister interface {
	...
	List(selector labels.Selector) (ret []*policieskyvernoiov1beta1.PolicyException, err error)
...
type policyExceptionLister struct {
	listers.ResourceIndexer[*policieskyvernoiov1beta1.PolicyException]
}
...
func NewPolicyExceptionLister(indexer cache.Indexer) PolicyExceptionLister {
	return &policyExceptionLister{listers.New[*policieskyvernoiov1beta1.PolicyException](indexer, policieskyvernoiov1beta1.Resource("policyexception"))}
}

// PolicyExceptions returns an object that can list and get PolicyExceptions.
func (s *policyExceptionLister) PolicyExceptions(namespace string) PolicyExceptionNamespaceLister {
	return policyExceptionNamespaceLister{listers.NewNamespaced[*policieskyvernoiov1beta1.PolicyException](s.ResourceIndexer, namespace)}
}
...
type PolicyExceptionNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*policieskyvernoiov1beta1.PolicyException, error)
