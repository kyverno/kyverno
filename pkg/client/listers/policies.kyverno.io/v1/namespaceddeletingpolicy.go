...
type NamespacedDeletingPolicyLister interface {
	...
	List(selector labels.Selector) (ret []*policieskyvernoiov1.NamespacedDeletingPolicy, err error)
...
type namespacedDeletingPolicyLister struct {
	listers.ResourceIndexer[*policieskyvernoiov1.NamespacedDeletingPolicy]
}
...
func NewNamespacedDeletingPolicyLister(indexer cache.Indexer) NamespacedDeletingPolicyLister {
	return &namespacedDeletingPolicyLister{listers.New[*policieskyvernoiov1.NamespacedDeletingPolicy](indexer, policieskyvernoiov1.Resource("namespaceddeletingpolicy"))}
}
...
func (s *namespacedDeletingPolicyLister) NamespacedDeletingPolicies(namespace string) NamespacedDeletingPolicyNamespaceLister {
	return namespacedDeletingPolicyNamespaceLister{listers.NewNamespaced[*policieskyvernoiov1.NamespacedDeletingPolicy](s.ResourceIndexer, namespace)}
}
...
type NamespacedDeletingPolicyNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*policieskyvernoiov1.NamespacedDeletingPolicy, error)
