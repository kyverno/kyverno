...
type NamespacedValidatingPolicyLister interface {
	...
	List(selector labels.Selector) (ret []*policieskyvernoiov1alpha1.NamespacedValidatingPolicy, err error)
...
type namespacedValidatingPolicyLister struct {
	listers.ResourceIndexer[*policieskyvernoiov1alpha1.NamespacedValidatingPolicy]
}
...
func NewNamespacedValidatingPolicyLister(indexer cache.Indexer) NamespacedValidatingPolicyLister {
	return &namespacedValidatingPolicyLister{listers.New[*policieskyvernoiov1alpha1.NamespacedValidatingPolicy](indexer, policieskyvernoiov1alpha1.Resource("namespacedvalidatingpolicy"))}
}
...
func (s *namespacedValidatingPolicyLister) NamespacedValidatingPolicies(namespace string) NamespacedValidatingPolicyNamespaceLister {
	return namespacedValidatingPolicyNamespaceLister{listers.NewNamespaced[*policieskyvernoiov1alpha1.NamespacedValidatingPolicy](s.ResourceIndexer, namespace)}
}
...
type NamespacedValidatingPolicyNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*policieskyvernoiov1alpha1.NamespacedValidatingPolicy, error)
