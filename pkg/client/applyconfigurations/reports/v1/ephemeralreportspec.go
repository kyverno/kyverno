...
import (
	v1beta1 "github.com/kyverno/kyverno/pkg/client/applyconfigurations/policyreport/v1beta1"
...
type EphemeralReportSpecApplyConfiguration struct {
	...
	Summary *v1beta1.PolicyReportSummaryApplyConfiguration `json:"summary,omitempty"`
	Results []v1beta1.PolicyReportResultApplyConfiguration `json:"results,omitempty"`
}
...
func (b *EphemeralReportSpecApplyConfiguration) WithSummary(value *v1beta1.PolicyReportSummaryApplyConfiguration) *EphemeralReportSpecApplyConfiguration {
	b.Summary = value
	return b
}
...
func (b *EphemeralReportSpecApplyConfiguration) WithResults(values ...*v1beta1.PolicyReportResultApplyConfiguration) *EphemeralReportSpecApplyConfiguration {
	for i := range values {
		if values[i] == nil {
