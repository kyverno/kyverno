...
// RequestDataApplyConfiguration represents an declarative configuration of the RequestData type for use
// with apply.
...
// RequestDataApplyConfiguration constructs an declarative configuration of the RequestData type for use with
// apply.
func RequestData() *RequestDataApplyConfiguration {
	return &RequestDataApplyConfiguration{}
}
