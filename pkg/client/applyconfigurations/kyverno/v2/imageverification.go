...
type ImageVerificationApplyConfiguration struct {
	Type                     *v2.ImageVerificationType                   `json:"type,omitempty"`
...
func (b *ImageVerificationApplyConfiguration) WithType(value v2.ImageVerificationType) *ImageVerificationApplyConfiguration {
	b.Type = &value
	return b
}
