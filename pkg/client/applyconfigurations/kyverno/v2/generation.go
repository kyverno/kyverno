...
type GenerationApplyConfiguration struct {
	*v1.ResourceSpecApplyConfiguration `json:"ResourceSpec,omitempty"`
	GenerateExisting                   *bool                           `json:"generateExisting,omitempty"`
	Synchronize                        *bool                           `json:"synchronize,omitempty"`
	RawData                            *apiextensionsv1.JSON           `json:"data,omitempty"`
	Clone                              *v1.CloneFromApplyConfiguration `json:"clone,omitempty"`
	CloneList                          *v1.CloneListApplyConfiguration `json:"cloneList,omitempty"`
}
...
func (b *GenerationApplyConfiguration) ensureResourceSpecApplyConfigurationExists() {
	if b.ResourceSpecApplyConfiguration == nil {
		b.ResourceSpecApplyConfiguration = &v1.ResourceSpecApplyConfiguration{}
	}
}
...
func (b *GenerationApplyConfiguration) WithClone(value *v1.CloneFromApplyConfiguration) *GenerationApplyConfiguration {
	b.Clone = value
	return b
}
...
func (b *GenerationApplyConfiguration) WithCloneList(value *v1.CloneListApplyConfiguration) *GenerationApplyConfiguration {
	b.CloneList = value
	return b
}
