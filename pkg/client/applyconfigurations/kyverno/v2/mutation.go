...
type MutationApplyConfiguration struct {
	...
	RawPatchStrategicMerge       *v1.JSON                                      `json:"patchStrategicMerge,omitempty"`
	PatchesJSON6902              *string                                       `json:"patchesJson6902,omitempty"`
	ForEachMutation              []kyvernov1.ForEachMutationApplyConfiguration `json:"foreach,omitempty"`
}
...
func (b *MutationApplyConfiguration) WithRawPatchStrategicMerge(value v1.JSON) *MutationApplyConfiguration {
...
func (b *MutationApplyConfiguration) WithForEachMutation(values ...*kyvernov1.ForEachMutationApplyConfiguration) *MutationApplyConfiguration {
	for i := range values {
		if values[i] == nil {
