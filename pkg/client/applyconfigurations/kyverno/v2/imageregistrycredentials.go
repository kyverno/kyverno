...
type ImageRegistryCredentialsApplyConfiguration struct {
	...
	Providers             []v2.ImageRegistryCredentialsProvidersType `json:"providers,omitempty"`
...
func (b *ImageRegistryCredentialsApplyConfiguration) WithProviders(values ...v2.ImageRegistryCredentialsProvidersType) *ImageRegistryCredentialsApplyConfiguration {
	for i := range values {
