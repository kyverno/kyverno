...
type ConditionApplyConfiguration struct {
	...
	Operator *policiesv1.ConditionOperator `json:"operator,omitempty"`
...
func (b *ConditionApplyConfiguration) WithOperator(value policiesv1.ConditionOperator) *ConditionApplyConfiguration {
	b.Operator = &value
	return b
}
