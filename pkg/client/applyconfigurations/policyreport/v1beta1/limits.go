...
type LimitsApplyConfiguration struct {
	...
	StatusFilter []v1beta1.StatusFilter `json:"statusFilter,omitempty"`
}
...
func (b *LimitsApplyConfiguration) WithStatusFilter(values ...v1beta1.StatusFilter) *LimitsApplyConfiguration {
	for i := range values {
