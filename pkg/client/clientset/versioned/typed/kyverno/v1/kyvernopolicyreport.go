...
// KyvernoPolicyReportsGetter has a method to return a KyvernoPolicyReportInterface.
// A group's client should implement this interface.
type KyvernoPolicyReportsGetter interface {
	KyvernoPolicyReports(namespace string) KyvernoPolicyReportInterface
}
...
// kyvernoPolicyReports implements KyvernoPolicyReportInterface
type kyvernoPolicyReports struct {
	client rest.Interface
	ns     string
}

// newKyvernoPolicyReports returns a KyvernoPolicyReports
func newKyvernoPolicyReports(c *KyvernoV1Client, namespace string) *kyvernoPolicyReports {
	return &kyvernoPolicyReports{
		client: c.RESTClient(),
		ns:     namespace,
	}
}
...
func (c *kyvernoPolicyReports) List(opts metav1.ListOptions) (result *v1.KyvernoPolicyReportList, err error) {
	...
	result = &v1.KyvernoPolicyReportList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("kyvernopolicyreports").
