...
type Interface interface {
	...
	CoreKyverno() corekyverno.CoreKyvernoInterface
...
type Clientset struct {
	*discovery.DiscoveryClient
	coreKyverno         *corekyverno.CoreKyvernoClient
...
func NewForConfigAndClient(c *rest.Config, httpClient *http.Client) (*Clientset, error) {
	...
	var cs Clientset
	var err error
	cs.coreKyverno, err = corekyverno.NewForConfigAndClient(&configShallowCopy, httpClient)
	if err != nil {
		return nil, err
	}
...
func New(c rest.Interface) *Clientset {
	var cs Clientset
	cs.coreKyverno = corekyverno.New(c)
