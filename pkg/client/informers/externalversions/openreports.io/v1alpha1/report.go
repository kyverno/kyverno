...
import (
	...
	apireportv1alpha2 "github.com/kyverno/kyverno/api/openreports.io/v1alpha1"
	v1 "k8s.io/apimachinery/pkg/apis/meta/v1"
	runtime "k8s.io/apimachinery/pkg/runtime"
	watch "k8s.io/apimachinery/pkg/watch"
	cache "k8s.io/client-go/tools/cache"
	reportv1alpha2 "github.com/kyverno/kyverno/pkg/client/listers/openreports.io/v1alpha1"
...
type ReportInformer interface {
	...
	Lister() reportv1alpha2.ReportLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.OpenreportsV1alpha1().Reports(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.OpenreportsV1alpha1().Reports(namespace).Watch(context.TODO(), options)
			},
		},
		&apireportv1alpha2.Report{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *reportInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apireportv1alpha2.Report{}, f.defaultInformer)
}

func (f *reportInformer) Lister() reportv1alpha2.ReportLister {
	return reportv1alpha2.NewReportLister(f.Informer().GetIndexer())
}