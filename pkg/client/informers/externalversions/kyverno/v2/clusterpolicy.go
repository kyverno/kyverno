	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KyvernoV2().ClusterPolicies().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV2().ClusterPolicies().Watch(context.TODO(), options)
			},
		},
		&kyvernov2.ClusterPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kyvernov2.ClusterPolicy{}, f.defaultInformer)
}

func (f *clusterPolicyInformer) Lister() v2.ClusterPolicyLister {
	return v2.NewClusterPolicyLister(f.Informer().GetIndexer())
}
