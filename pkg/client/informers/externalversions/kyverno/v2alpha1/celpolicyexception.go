...
type CELPolicyExceptionInformer interface {
	...
	Lister() v2alpha1.CELPolicyExceptionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KyvernoV2alpha1().CELPolicyExceptions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV2alpha1().CELPolicyExceptions(namespace).Watch(context.TODO(), options)
			},
		},
		&kyvernov2alpha1.CELPolicyException{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cELPolicyExceptionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kyvernov2alpha1.CELPolicyException{}, f.defaultInformer)
}

func (f *cELPolicyExceptionInformer) Lister() v2alpha1.CELPolicyExceptionLister {
	return v2alpha1.NewCELPolicyExceptionLister(f.Informer().GetIndexer())
}
