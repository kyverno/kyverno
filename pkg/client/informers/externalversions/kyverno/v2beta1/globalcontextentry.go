...
import (
	...
	apikyvernov2beta1 "github.com/kyverno/kyverno/api/kyverno/v2beta1"
	versioned "github.com/kyverno/kyverno/pkg/client/clientset/versioned"
	internalinterfaces "github.com/kyverno/kyverno/pkg/client/informers/externalversions/internalinterfaces"
	kyvernov2beta1 "github.com/kyverno/kyverno/pkg/client/listers/kyverno/v2beta1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KyvernoV2beta1().GlobalContextEntries().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KyvernoV2beta1().GlobalContextEntries().Watch(context.TODO(), options)
			},
		},
