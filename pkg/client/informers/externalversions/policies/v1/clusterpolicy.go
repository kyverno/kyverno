...
import (
	...
	v1 "github.com/kyverno/kyverno/pkg/client/listers/policies/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PoliciesV1().ClusterPolicies().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().ClusterPolicies().Watch(context.TODO(), options)
			},
		},
		&policiesv1.ClusterPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&policiesv1.ClusterPolicy{}, f.defaultInformer)
}
