...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("clusterreports"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Openreports().V1alpha1().ClusterReports().Informer()}, nil
	case v1alpha1.SchemeGroupVersion.WithResource("reports"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Openreports().V1alpha1().Reports().Informer()}, nil
