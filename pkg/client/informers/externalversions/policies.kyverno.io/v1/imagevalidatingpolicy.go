...
type ImageValidatingPolicyInformer interface {
	...
	Lister() policieskyvernoiov1.ImageValidatingPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PoliciesV1().ImageValidatingPolicies().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().ImageValidatingPolicies().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().ImageValidatingPolicies().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().ImageValidatingPolicies().Watch(ctx, options)
			},
		},
		&apipolicieskyvernoiov1.ImageValidatingPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *imageValidatingPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apipolicieskyvernoiov1.ImageValidatingPolicy{}, f.defaultInformer)
}

func (f *imageValidatingPolicyInformer) Lister() policieskyvernoiov1.ImageValidatingPolicyLister {
	return policieskyvernoiov1.NewImageValidatingPolicyLister(f.Informer().GetIndexer())
}
