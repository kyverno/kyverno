...
type MutatingPolicyInformer interface {
	...
	Lister() policieskyvernoiov1.MutatingPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PoliciesV1().MutatingPolicies().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().MutatingPolicies().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().MutatingPolicies().List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().MutatingPolicies().Watch(ctx, options)
			},
		},
		&apipolicieskyvernoiov1.MutatingPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *mutatingPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apipolicieskyvernoiov1.MutatingPolicy{}, f.defaultInformer)
}

func (f *mutatingPolicyInformer) Lister() policieskyvernoiov1.MutatingPolicyLister {
	return policieskyvernoiov1.NewMutatingPolicyLister(f.Informer().GetIndexer())
}
