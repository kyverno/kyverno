...
type NamespacedDeletingPolicyInformer interface {
	...
	Lister() policieskyvernoiov1.NamespacedDeletingPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PoliciesV1().NamespacedDeletingPolicies(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().NamespacedDeletingPolicies(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().NamespacedDeletingPolicies(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().NamespacedDeletingPolicies(namespace).Watch(ctx, options)
			},
		}, client),
		&apipolicieskyvernoiov1.NamespacedDeletingPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *namespacedDeletingPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apipolicieskyvernoiov1.NamespacedDeletingPolicy{}, f.defaultInformer)
}

func (f *namespacedDeletingPolicyInformer) Lister() policieskyvernoiov1.NamespacedDeletingPolicyLister {
	return policieskyvernoiov1.NewNamespacedDeletingPolicyLister(f.Informer().GetIndexer())
}
