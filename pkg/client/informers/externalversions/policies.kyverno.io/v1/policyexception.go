...
type PolicyExceptionInformer interface {
	...
	Lister() policieskyvernoiov1.PolicyExceptionLister
}
	...
	return cache.NewSharedIndexInformer(
		cache.ToListWatcherWithWatchListSemantics(&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PoliciesV1().PolicyExceptions(namespace).List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().PolicyExceptions(namespace).Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().PolicyExceptions(namespace).List(ctx, options)
			},
			WatchFuncWithContext: func(ctx context.Context, options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().PolicyExceptions(namespace).Watch(ctx, options)
			},
		}, client),
		&apipolicieskyvernoiov1.PolicyException{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *policyExceptionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apipolicieskyvernoiov1.PolicyException{}, f.defaultInformer)
}

func (f *policyExceptionInformer) Lister() policieskyvernoiov1.PolicyExceptionLister {
	return policieskyvernoiov1.NewPolicyExceptionLister(f.Informer().GetIndexer())
}
