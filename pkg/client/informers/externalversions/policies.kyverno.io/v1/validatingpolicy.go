...
type ValidatingPolicyInformer interface {
	...
	Lister() policieskyvernoiov1.ValidatingPolicyLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.PoliciesV1().ValidatingPolicies().List(context.Background(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().ValidatingPolicies().Watch(context.Background(), options)
			},
			ListWithContextFunc: func(ctx context.Context, options metav1.ListOptions) (runtime.Object, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PoliciesV1().ValidatingPolicies().List(ctx, options)
			},
...
func (f *validatingPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apipolicieskyvernoiov1.ValidatingPolicy{}, f.defaultInformer)
}

func (f *validatingPolicyInformer) Lister() policieskyvernoiov1.ValidatingPolicyLister {
	return policieskyvernoiov1.NewValidatingPolicyLister(f.Informer().GetIndexer())
}
