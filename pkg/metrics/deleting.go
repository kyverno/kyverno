...
type DeletingMetrics interface {
	RecordDeletedObject(ctx context.Context, resource, namespace string, policy v1alpha1.DeletingPolicyLike, deletionPropagation *metav1.DeletionPropagation)
	RecordDeletingFailure(ctx context.Context, resource, namespace string, policy v1alpha1.DeletingPolicyLike, deletionPropagation *metav1.DeletionPropagation)
}
...
func (m *deletingMetrics) RecordDeletedObject(ctx context.Context, resource, namespace string, policy v1alpha1.DeletingPolicyLike, deletionPropagation *metav1.DeletionPropagation) {
...
func (m *deletingMetrics) RecordDeletingFailure(ctx context.Context, resource, namespace string, policy v1alpha1.DeletingPolicyLike, deletionPropagation *metav1.DeletionPropagation) {
