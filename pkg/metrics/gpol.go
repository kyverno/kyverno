...
type GeneratingMetrics interface {
	RecordDuration(ctx context.Context, seconds float64, status string, policy v1alpha1.GeneratingPolicy, resource *unstructured.Unstructured, operation string)
}
...
func (m *generatingMetrics) RecordDuration(ctx context.Context, seconds float64, status string, policy v1alpha1.GeneratingPolicy, resource *unstructured.Unstructured, operation string) {
