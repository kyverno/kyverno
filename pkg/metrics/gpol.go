...
type GeneratingMetrics interface {
	RecordDuration(ctx context.Context, seconds float64, status string, policy policiesv1beta1.GeneratingPolicyLike, resource *unstructured.Unstructured, operation string)
}
...
func (m *generatingMetrics) RecordDuration(ctx context.Context, seconds float64, status string, policy policiesv1beta1.GeneratingPolicyLike, resource *unstructured.Unstructured, operation string) {
