...
type ImageValidatingMetrics interface {
	RecordDuration(ctx context.Context, seconds float64, status, ruleExecutionCause string, policy v1alpha1.ImageValidatingPolicyLike, resource *unstructured.Unstructured, operation string)
}
...
func (m *imageValidatingMetrics) RecordDuration(ctx context.Context, seconds float64, status, ruleExecutionCause string, policy v1alpha1.ImageValidatingPolicyLike, resource *unstructured.Unstructured, operation string) {
