...
func GenerateAnnotationPatches(engineResponses []*api.EngineResponse, log logr.Logger) [][]byte {
...
func annotationFromEngineResponses(engineResponses []*api.EngineResponse, log logr.Logger) []byte {
...
func annotationFromPolicyResponse(policyResponse api.PolicyResponse, log logr.Logger) []RulePatch {
