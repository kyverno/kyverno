...
func IsResponseSuccessful(engineReponses []*api.EngineResponse) bool {
...
func BlockRequest(er *api.EngineResponse, failurePolicy kyvernov1.FailurePolicyType) bool {
