        ...
        "mutations": [
            {
                "patchType": "ApplyConfiguration",
                "applyConfiguration": {
                    "expression": "object.metadata.?labels[\"lfx-mentorship\"].hasValue() ? Object{} : Object{ metadata: Object.metadata{ labels: {\"lfx-mentorship\": \"kyverno\"}}}"
                }
            }
        ]
    }
