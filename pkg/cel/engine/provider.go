...
func listExceptions(polexLister policiesv1alpha1listers.CELPolicyExceptionLister, policyName, policyKind string) ([]*policiesv1alpha1.CELPolicyException, error) {
