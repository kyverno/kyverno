...
func TestFakeContextProvider_Clone(t *testing.T) {
	...
	original.SetGenerateContext("policyA", "default", "triggerA", "default", "v1", "", "Pod", "123", true, false, nil)
	...
	clone.SetGenerateContext("policyB", "kube-system", "triggerB", "kube-system", "v1", "", "Service", "456", false, false, nil)
