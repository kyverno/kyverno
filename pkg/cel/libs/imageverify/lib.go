...
type lib struct {
	...
	ivpol   policiesv1alpha1.ImageValidatingPolicyLike
...
func Lib(v *version.Version, imgCtx imagedataloader.ImageContext, ivpol policiesv1alpha1.ImageValidatingPolicyLike, lister k8scorev1.SecretInterface) cel.EnvOption {
