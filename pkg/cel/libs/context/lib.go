...
func (c *lib) extendEnv(env *cel.Env) (*cel.Env, error) {
	...
	libraryDecls := map[string][]cel.FunctionOpt{
		...
		"ListResource": {
			// TODO: should not use DynType in return
			cel.MemberOverload("list_resource_string", []*cel.Type{ContextType, types.StringType, types.StringType, types.StringType, types.StringType}, types.DynType, cel.FunctionBinding(impl.list_resource_string)),
		},
		"GetResource": {
			// TODO: should not use DynType in return
			cel.MemberOverload("get_resource_string", []*cel.Type{ContextType, types.StringType, types.StringType, types.StringType, types.StringType, types.StringType}, types.DynType, cel.FunctionBinding(impl.get_resource_string)),
		},
	}
