...
func (r *reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if len(errs) > 0 {
		logging.Error(errs.ToAggregate(), "failed to compile policy", "policy", req.NamespacedName.String())
		r.lock.Lock()
		delete(r.policies, req.NamespacedName.String())
		r.lock.Unlock()
		return ctrl.Result{}, nil
	...
	for _, gen := range generated {
		...
		*autogenPolicy.GetSpec() = *gen.Spec
		...
		if len(errs) > 0 {
			logging.Error(errs.ToAggregate(), "failed to compile autogenerated policy", "policy", req.NamespacedName.String())
			continue
		}
