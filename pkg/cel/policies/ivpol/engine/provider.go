...
func NewProvider(policies []policiesv1alpha1.ImageValidatingPolicyLike, exceptions []*policiesv1alpha1.PolicyException) (ProviderFunc, error) {
	...
	for _, policy := range policies {
		...
		if ivp, ok := p.(*v1alpha1.ImageValidatingPolicy); ok {
