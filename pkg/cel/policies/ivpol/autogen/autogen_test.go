...
func Test_AutogenImageVerify(t *testing.T) {
	...
	assert.Equal(t, 1, len(autogenerated[ControllerKeys(autogen.AutogenCronjobs, ivpol.GetName())].Spec.ImageExtractors))
	assert.Equal(t, cronimg, autogenerated[ControllerKeys(autogen.AutogenCronjobs, ivpol.GetName())].Spec.ImageExtractors)
	pol := ivpol.DeepCopy()
	...
	assert.Equal(t, 1, len(autogenerated[ControllerKeys(autogen.AutogenDefaults, ivpol.GetName())].Spec.ImageExtractors))
	assert.Equal(t, podctrlimg, autogenerated[ControllerKeys(autogen.AutogenDefaults, ivpol.GetName())].Spec.ImageExtractors)
	assert.Equal(t, cronRule, autogenerated[ControllerKeys(autogen.AutogenCronjobs, ivpol.GetName())].Spec.MatchConstraints.ResourceRules)
}
