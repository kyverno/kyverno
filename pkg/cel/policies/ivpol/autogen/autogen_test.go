...
func Test_AutogenPodControllersEnabled(t *testing.T) {
	pol := ivpol.DeepCopy()
	pol.Spec.AutogenConfiguration.PodControllers.Enabled = ptr.To(false)
	autogenerated, err := Autogen(pol)
	assert.NoError(t, err)
	assert.Nil(t, autogenerated)

	pol.Spec.AutogenConfiguration.PodControllers.Controllers = []string{"deployments"}
	autogenerated, err = Autogen(pol)
	assert.NoError(t, err)
	assert.Nil(t, autogenerated, "enabled=false must take precedence over a non-empty controllers list")

	pol.Spec.AutogenConfiguration.PodControllers.Enabled = ptr.To(true)
	autogenerated, err = Autogen(pol)
	assert.NoError(t, err)
	assert.NotEmpty(t, autogenerated)
}
