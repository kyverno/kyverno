...
func TestMatchNames(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			names: []string{},
			policies: []policiesv1beta1.ValidatingPolicyLike{
				&policiesv1beta1.ValidatingPolicy{ObjectMeta: metav1.ObjectMeta{Name: "p1"}},
				&policiesv1beta1.ValidatingPolicy{ObjectMeta: metav1.ObjectMeta{Name: "any"}},
			},
		...
		},
		{
			...
			policies: []policiesv1beta1.ValidatingPolicyLike{
				&policiesv1beta1.ValidatingPolicy{ObjectMeta: metav1.ObjectMeta{Name: "p1"}},
				&policiesv1beta1.ValidatingPolicy{ObjectMeta: metav1.ObjectMeta{Name: "p2"}},
			},
		...
		},
		{
			...
			policies: []policiesv1beta1.ValidatingPolicyLike{
				&policiesv1beta1.ValidatingPolicy{ObjectMeta: metav1.ObjectMeta{Name: "p1"}},
				&policiesv1beta1.ValidatingPolicy{ObjectMeta: metav1.ObjectMeta{Name: "p2"}},
				&policiesv1beta1.ValidatingPolicy{ObjectMeta: metav1.ObjectMeta{Name: "p3"}},
			},
