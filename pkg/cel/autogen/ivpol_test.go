...
func Test_AutogenImageVerify(t *testing.T) {
	...
	autogenerated, err := ImageValidatingPolicy(ivpol)
	assert.NoError(t, err)
	assert.Equal(t, 1, len(autogenerated))
	assert.Equal(t, cronRule, autogenerated[ControllerKeys(AutogenCronjobs, ivpol.GetName())].Spec.MatchConstraints.ResourceRules)
	assert.Equal(t, 1, len(autogenerated[ControllerKeys(AutogenCronjobs, ivpol.GetName())].Spec.Images))
	assert.Equal(t, cronimg, autogenerated[ControllerKeys(AutogenCronjobs, ivpol.GetName())].Spec.Images)
	pol := ivpol.DeepCopy()
	...
	autogenerated, err = ImageValidatingPolicy(pol)
	assert.NoError(t, err)
	assert.Equal(t, 2, len(autogenerated))
	assert.Equal(t, podctrl, autogenerated[ControllerKeys(AutogenDefaults, ivpol.GetName())].Spec.MatchConstraints.ResourceRules)
	assert.Equal(t, 1, len(autogenerated[ControllerKeys(AutogenDefaults, ivpol.GetName())].Spec.Images))
	assert.Equal(t, podctrlimg, autogenerated[ControllerKeys(AutogenDefaults, ivpol.GetName())].Spec.Images)
	assert.Equal(t, cronRule, autogenerated[ControllerKeys(AutogenCronjobs, ivpol.GetName())].Spec.MatchConstraints.ResourceRules)
}
