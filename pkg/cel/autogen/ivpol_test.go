...
func Test_AutogenImageVerify(t *testing.T) {
	...
	assert.Equal(t, cronRule, autogenerated["cronjobs"].Spec.MatchConstraints.ResourceRules)
	assert.Equal(t, 1, len(autogenerated["cronjobs"].Spec.Images))
	assert.Equal(t, cronimg, autogenerated["cronjobs"].Spec.Images)
	pol := ivpol.DeepCopy()
	...
	assert.Equal(t, podctrl, autogenerated[""].Spec.MatchConstraints.ResourceRules)
	assert.Equal(t, 1, len(autogenerated[""].Spec.Images))
	assert.Equal(t, podctrlimg, autogenerated[""].Spec.Images)
	assert.Equal(t, cronRule, autogenerated["cronjobs"].Spec.MatchConstraints.ResourceRules)
}
