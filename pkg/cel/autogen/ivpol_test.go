...
func Test_AutogenImageVerify(t *testing.T) {
	...
	assert.Equal(t, autogenerated[0].Name, "autogen-test")
	assert.Equal(t, autogenerated[0].Spec.MatchConstraints.ResourceRules, podctrl)
	assert.Equal(t, len(autogenerated[0].Spec.Images), 1)
	assert.Equal(t, autogenerated[0].Spec.Images, podctrlimg)
	assert.Equal(t, autogenerated[1].Spec.MatchConstraints.ResourceRules, cronRule)
}
