...
Within a version, only optional, backward-compatible attributes can be added — a new required field, or stricter
validation that could reject previously-valid writes, needs a new version instead (see api-versioning.md above).
