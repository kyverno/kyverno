...
func runTest(out io.Writer, testCase test.TestCase, registryAccess bool) (*TestResponse, error) {
	...
	resources, err := common.GetResourceAccordingToResourcePath(out, testCase.Fs, resourceFullPath, false, genericPolicies, dClient, "", false, false, testDir, false)
	if err != nil {
	...
	targetResources, err := common.GetResourceAccordingToResourcePath(out, testCase.Fs, targetResourcesPath, false, genericPolicies, dClient, "", false, false, testDir, false)
	if err != nil {
