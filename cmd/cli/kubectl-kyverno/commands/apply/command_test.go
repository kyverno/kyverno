...
func Test_Apply(t *testing.T) {
	...
	testcases := []*TestCase{
		{
			config: ApplyCommandConfig{
				PolicyPaths:              []string{"../../../../../test/cli/apply/exceptions-within-policy/pol"},
				ResourcePaths:            []string{"../../../../../test/cli/apply/exceptions-within-policy/res"},
		...
		{
			config: ApplyCommandConfig{
				PolicyPaths:               []string{"../../../../../test/cli/apply/exceptions-within-resource/pol"},
				ResourcePaths:             []string{"../../../../../test/cli/apply/exceptions-within-resource/res"},
		...
		{
			config: ApplyCommandConfig{
				PolicyPaths:               []string{"../../../../../test/cli/apply/exceptions-within-policy-and-resource/pol"},
				ResourcePaths:             []string{"../../../../../test/cli/apply/exceptions-within-policy-and-resource/res"},
				exceptionsWithInResources: true,
				exceptionsWithInPolicies:  true,
				PolicyReport:              true,
			},
