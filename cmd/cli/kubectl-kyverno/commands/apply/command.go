...
func Command() *cobra.Command {
	...
	cmd.Flags().BoolVar(&applyCommandConfig.AuditWarn, "audit-warn", false, "If set to true, all policy failures(including enforce actions) will be flagged as warnings instead of failures")
