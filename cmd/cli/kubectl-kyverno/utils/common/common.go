...
func LoadCrdFromPath(path string) error {
	...
	addResourceGroup(apiGroupResource)
...
func addResourceGroup(resource *restmapper.APIGroupResources) {
	data.AddResourceGroup(resource)
}
...
func buildImageExtractors(paths []string) []policyV1alpha1.ImageExtractor {
	var extractors []policyV1alpha1.ImageExtractor
