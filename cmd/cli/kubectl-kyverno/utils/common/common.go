...
OuterLoop:
	...
	if policyHasValidate {
		validateResponse = engine.Validate(context.TODO(), registryclient.NewOrDie(), policyContext)
	...
	verifyImageResponse, _ := engine.VerifyAndPatchImages(context.TODO(), registryclient.NewOrDie(), policyContext)
