...
import (
	...
	"github.com/kyverno/kyverno/cmd/cli/kubectl-kyverno/sysdump"
...
func registerCommands(cli *cobra.Command) {
	cli.AddCommand(version.Command(), create.Command(), apply.Command(), test.Command(), jp.Command(), sysdump.Command())
