...
func main() {
	...
	flagset.Int64Var(&maxAPICallResponseLength, "maxAPICallResponseLength", 10*1000*1000, "Maximum allowed response size from API Calls. A value of 0 bypasses checks (not recommended).")
