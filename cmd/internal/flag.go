...
func initMetricsFlags() {
	...
	flag.StringVar(&metricsTlsSecretName, "metricsTlsSecretName", "kyverno-<controller-name>-metrics-tls", "The secret name which contains the TLS certs for the metrics endpoint.")
